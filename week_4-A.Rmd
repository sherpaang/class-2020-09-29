...
d_2019_take_2 <-
  read_enrollment("raw_data/class_enrollment_summary_by_term_12.20.19.xlsx")
...
```{r}
read_enrollment <- function(file, skip) {
...
d_2018 <-
  read_enrollment("raw_data/class_enrollment_summary_by_term_10.24.18.xlsx",
                  skip = 2)

d_2017 <-
  read_enrollment("raw_data/class_enrollment_summary_by_term_10.20.17.xlsx",
                  skip = 2)

example_2017 <- read_excel(
  "raw_data/class_enrollment_summary_by_term_10.20.17.xlsx"
)

view(example_2017)

d_2016 <-
  read_enrollment("raw_data/class_enrollment_summary_by_term_fall_2016.xlsx",
                  skip = 0)

d_2015 <-
  read_enrollment("raw_data/class_enrollment_summary_by_term_fall_2015.xlsx",
                  skip = 3)
```
